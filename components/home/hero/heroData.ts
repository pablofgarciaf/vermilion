...
export const HERO_SLIDES_DATA: SlideData[] = [
  {
    ...
    title2: { en: 'GALAPAGOS ISLAND', es: 'DE GALÁPAGOS', fr: 'DES GALAPAGOS', de: 'DER GALAPAGOS', it: 'DELLE GALAPAGOS', pt: 'DE GALÁPAGOS', ja: 'ガラパゴスゾウガメ', zh: '加拉帕戈斯陆龟' },
    description: {
  ...
  },
  {
    ...
    title2: { en: 'CRATER LAKE', es: 'QUILOTOA', fr: 'DU QUILOTOA', de: 'VON QUILOTOA', it: 'QUILOTOA', pt: 'DO QUILOTOA', ja: 'キロトア火口湖', zh: '基洛托阿火山湖' },
    description: {
