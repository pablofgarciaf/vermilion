  ...
  return (
    ...
    >
      ...
      <div className="indicator fixed top-0 left-0 right-0 h-[3px] bg-white z-[60] will-change-transform" />
        ...
        <div aria-hidden="true" className="absolute inset-0 z-[21] pointer-events-none bg-transparent md:bg-[linear-gradient(90deg,rgba(0,0,0,0.82)_0%,rgba(0,0,0,0.6)_28%,rgba(0,0,0,0.25)_52%,transparent_70%)]" />
