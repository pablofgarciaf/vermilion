...
export function BlogIndexClient({ hideHeader = false }: BlogIndexClientProps) {
  ...
  const i18nBlog: Record<string, {
    ...
    es: {
      ...
      clubDesc: 'Únete a más de 2.500 viajeros que reciben alertas de migración de fauna, ofertas de cruceros boutique e itinerarios privados personalizados.',
    ...
    en: {
      ...
      clubDesc: 'Join over 2,500 travelers receiving curated boutique cruise offers, wildlife migration alerts, and private itinerary inspirations.',
    ...
    pt: {
      ...
      clubDesc: 'Junte-se a mais de 2.500 viajantes que recebem ofertas de cruzeiros exclusivos, alertas de fauna e roteiros privativos personalizados.',
    ...
    ja: {
      ...
      clubDesc: '2,500名以上の旅行者が購読中。野生動物の移動シーズン情報や厳選クルーズの特別オファーをお届けします。',
    ...
    zh: {
      ...
      clubDesc: '加入超过 2,500 位自然旅行者社群，尊享野生动物迁徙快讯、精选游轮特惠及私人定制灵感。',
