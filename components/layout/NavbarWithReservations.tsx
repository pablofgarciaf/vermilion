...
export function NavbarWithReservations() {
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <span className="text-white">info@vermilionroutes.com</span>
            </a>
          </div>
              ...
              if (link.hasDropdown) {
                return (
                  ...
                  >
                    ...
                    >
                      {link.name}
                      <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${destinationsOpen ? 'rotate-180 text-emerald-600' : ''}`} />
                    </a>
                    {destinationsOpen && (
