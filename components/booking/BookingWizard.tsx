      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start">
        <div className="lg:col-span-8 space-y-5">
          <div className="bg-white dark:bg-zinc-900 rounded-3xl p-5 sm:p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-6">
                ...
                <div className="border-2 border-emerald-500 bg-gradient-to-br from-emerald-50/90 to-teal-50/40 dark:from-emerald-950/40 dark:to-zinc-900/80 rounded-3xl p-5 sm:p-6 shadow-lg ring-1 ring-emerald-500/30 space-y-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    <div className="w-full sm:w-44 h-44 sm:h-36 rounded-2xl overflow-hidden shrink-0 border border-emerald-200 dark:border-emerald-800 shadow-md relative">
                      ...
                      />
                      <span className="absolute top-2 left-2 px-2.5 py-1 rounded-lg bg-emerald-700/90 text-white font-bold text-[10px] uppercase tracking-wider shadow-md backdrop-blur-xs">
                        {isEs ? 'Principal' : 'Primary'}
                      </span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1.5">
                        <span className="px-2.5 py-0.5 rounded-full bg-emerald-600/15 text-emerald-700 dark:text-emerald-300 font-bold text-[10px] uppercase tracking-wider">
                    ...
                    <div className="sm:text-right shrink-0">
                      ...
                      <span className="text-2xl sm:text-3xl font-extrabold text-emerald-600 dark:text-emerald-400" suppressHydrationWarning>
            ...
            {/* CARRUSEL DE EXPEDICIONES RECOMENDADAS PARA COMBINAR (ANTES DEL FOOTER) */}
              ...
              <div className="pt-6 border-t border-zinc-200/80 dark:border-zinc-800/80 space-y-4">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">
                        {ci18n.sectionTitle}
                      </h4>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="pt-3 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between gap-2">
                          ...
                          >
                            {isAdded ? (isEs ? 'Añadido ✓' : 'Added ✓') : (isEs ? '+ Añadir extensión' : '+ Add extension')}
                          </button>
                        </div>
                      </div>
                    );
