        ...
        <div className="space-y-4 pb-5 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <div className="bg-zinc-100/80 dark:bg-zinc-900/80 p-1 rounded-xl flex items-center relative overflow-hidden mt-2 z-10">
            ...
            <button
              ...
              className={`relative z-10 w-1/2 py-2 text-xs font-extrabold transition-colors uppercase tracking-wider cursor-pointer ${
          ...
          <div className="flex items-center gap-1.5 text-xs text-emerald-700 dark:text-emerald-400 font-semibold pt-2">
